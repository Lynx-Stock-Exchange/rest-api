...
public class MarkerEvent {
    ...
    public MarkerEvent(String event_id, String event_type, String scope, String target, double magnitude, int duration_ticks, String headline, long triggered_at, String triggered_by) {
